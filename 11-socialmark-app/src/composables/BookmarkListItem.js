...
const categoryName = computed(()=> item?.category?.categoryName || "-")
const userName = computed(()=>item?.user?.fullname || "-")
const alreadyLiked = computed(()=>Boolean(likedItem))
const alreadyBookmarked = computed(()=>Boolean(bookmarkedItem))
