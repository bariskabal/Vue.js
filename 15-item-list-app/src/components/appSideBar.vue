<template>
    <aside class="bg-gray-700 w-[300px] h-screen">
      ...
      <div v-for="i in invoiceList" :key="i" class="odd:bg-gray-600 flex justify-between items-center p-2">
        <span>{{i.id.toString().slice(0,4)}}</span>
        <span>{{i.contact.contact_name}}</span>
        <span>
          ...
          <button @click="editInvoice(i)" class="purple-button">
